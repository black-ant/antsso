package com.gang.antsso.saml.controller;

import com.gang.antsso.saml.config.IdpConfiguration;
import com.gang.antsso.saml.logic.SAMLAttribute;
import com.gang.antsso.saml.logic.SAMLMessageHandler;
import com.gang.antsso.saml.logic.SAMLPrincipal;
...
public class SsoController {
    ...
    public void singleSignOnServiceGet(HttpServletRequest request, HttpServletResponse response, Authentication authentication)
            throws IOException, MarshallingException, SignatureException, MessageEncodingException, ValidationException, SecurityException,
    ...
    private void doSSO(HttpServletRequest request, HttpServletResponse response, Authentication authentication, boolean postRequest) throws ValidationException, SecurityException, MessageDecodingException, MarshallingException, SignatureException, MessageEncodingException, MetadataProviderException, IOException, ServletException, SecurityException {
        ...
        String assertionConsumerServiceURL = idpConfiguration.getAcsEndpoint() != null ? idpConfiguration.getAcsEndpoint() :
