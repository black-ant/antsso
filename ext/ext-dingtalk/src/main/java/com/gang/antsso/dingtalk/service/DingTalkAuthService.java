...
import com.gang.antsso.auth.api.logic.IOAuthService;
...
/**
 * @Classname DingTalkAuthService
 * @Description TODO
 * @Date 2020/5/1 22:46
 * @Created by zengzg
 */
@Component
public class DingTalkAuthService implements IOAuthService {
    ...
    public String executeRqCode(InternetRequestTO request) throws Exception {
        ...
        codeBody.put("tmp_auth_code", request.getParams().get("code"));
