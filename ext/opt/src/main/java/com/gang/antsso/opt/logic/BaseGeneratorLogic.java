 ...
 */
public class BaseGeneratorLogic {
    ...
    public BaseGeneratorLogic() throws NoSuchAlgorithmException {
        this(DEFAULT_PASSWORD_LENGTH);
    }

    public BaseGeneratorLogic(final int passwordLength) throws NoSuchAlgorithmException {
        this(passwordLength, HOTP_HMAC_ALGORITHM);
    }

    protected BaseGeneratorLogic(final int passwordLength, final String algorithm) throws NoSuchAlgorithmException {
