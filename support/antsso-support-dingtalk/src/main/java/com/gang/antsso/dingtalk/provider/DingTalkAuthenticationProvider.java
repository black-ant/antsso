package com.gang.antsso.dingtalk.provider;
...
import com.gang.antsso.dingtalk.service.DingTalkUserInfoService;
import com.gang.antsso.dingtalk.token.DingTalkUserToken;
...
public class DingTalkAuthenticationProvider implements AuthenticationProvider {
    ...
    @Autowired
    private DingTalkUserInfoService userInfoService;
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        DingTalkUserToken result = new DingTalkUserToken(
                username,
    ...
    public boolean supports(Class<?> authentication) {
        return (DingTalkUserToken.class.isAssignableFrom(authentication));
    }
