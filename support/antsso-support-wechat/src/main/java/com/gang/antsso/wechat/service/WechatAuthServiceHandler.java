...
import com.gang.antsso.wechat.to.WechatInternetSetting;
 ...
 */
@Component
public class WechatAuthServiceHandler implements IOAuthServiceHandler {
    ...
    public String executeRqCode(InternetRequestTO request) throws Exception {
        ...
        WechatInternetSetting setting = JSONObject.parseObject(request.backSettingBody(), WechatInternetSetting.class);
        ...
        String url = TemplateResolve.jexlResolve(WechatProperties.RQCODE_URL, urlParam.toJSONString());
