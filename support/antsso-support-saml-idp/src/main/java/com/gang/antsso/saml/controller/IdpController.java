...
import com.gang.antsso.auth.api.to.BaseUserDetails;
import com.gang.antsso.saml.api.SharedController;
import com.gang.antsso.saml.config.IdpConfiguration;
import com.gang.antsso.saml.token.FederatedUserAuthenticationToken;
import com.gang.antsso.saml.type.AuthenticationMethod;
...
public class IdpController extends SharedController {
    ...
    @PutMapping("/users")
    public void addUser(@RequestBody BaseUserDetails user) {
