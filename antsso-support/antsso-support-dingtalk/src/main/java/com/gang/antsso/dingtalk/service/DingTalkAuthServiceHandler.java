...
import com.gang.antsso.dingtalk.to.DingTalkInternetSetting;
...
public class DingTalkAuthServiceHandler implements IOAuthServiceHandler {
    ...
    public String executeRqCode(InternetRequestTO request) throws Exception {
        ...
        DingTalkInternetSetting setting = JSONObject.parseObject(request.backSettingBody(), DingTalkInternetSetting.class);
