package com.gang.antsso.saml.logic;

import com.gang.antsso.saml.config.SpConfiguration;
...
public class ConfigurableSAMLProcessor extends SAMLProcessorImpl {
    ...
    public SAMLMessageContext sendMessage(SAMLMessageContext samlContext, boolean sign)
        ...
        AssertionConsumerService assertionConsumerService =
                roleDescriptor.getAssertionConsumerServices().stream().filter(service -> service.isDefault()).findAny().orElseThrow(() -> new RuntimeException("No default ACS"));
